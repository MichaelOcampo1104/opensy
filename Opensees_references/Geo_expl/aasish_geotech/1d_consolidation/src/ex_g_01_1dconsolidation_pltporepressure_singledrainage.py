...
# 1D consolidation single drainage
# Units: kN, m, sec
...
def main():
    ...
    fname_pp = "1dcon_porepressure_singledrainage.txt"
    fname_fig = "1dcon_porepressure_singledrainage.png"
    ...
    for rowidx, clr in zip(rowidxs, clrs):
        ...
        ax.plot(df.iloc[rowidx].values, depths, marker="o", mfc="white", color=clr)
    ax.invert_yaxis()
