...
def main():
    ...
    fnames = [
        "ex_g_02_siteresponse_multiyield_dependent_totalstress_accel.out",
        "ex_g_02_siteresponse_multiyield_dependent_totalstress_vel.out",
        "ex_g_02_siteresponse_multiyield_dependent_totalstress_disp.out",
    ]
    ...
    fname_fig = "ex_g_02_siteresponse_multilayer_pressuredependent_totalstress_surface_groundmotion.png"
