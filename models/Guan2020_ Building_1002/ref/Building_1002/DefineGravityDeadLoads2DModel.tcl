...
load	52	0	[expr -1*$LeaningColumnDeadLoadFloor2]	0; 
load	53	0	[expr -1*$LeaningColumnDeadLoadFloor3]	0; 
load	54	0	[expr -1*$LeaningColumnDeadLoadFloor4]	0; 
load	55	0	[expr -1*$LeaningColumnDeadLoadFloor5]	0; 
load	56	0	[expr -1*$LeaningColumnDeadLoadFloor6]	0; 
load	57	0	[expr -1*$LeaningColumnDeadLoadFloor7]	0; 
load	58	0	[expr -1*$LeaningColumnDeadLoadFloor8]	0; 
load	59	0	[expr -1*$LeaningColumnDeadLoadFloor9]	0; 
load	510	0	[expr -1*$LeaningColumnDeadLoadFloor10]	0; 
