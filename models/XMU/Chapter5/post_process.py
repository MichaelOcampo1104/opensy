...
Note: This model requires a custom OpenSeesPy build with SmearedConcrete
and SmearedCompositePlaneStress materials. Run model.py first with your
custom build to generate ODB data, then run this script.
"""
...
if not output_dir.exists():
    ...
    print("Run model.py first (with custom OpenSeesPy build) to generate ODB data.")
    sys.exit(1)
