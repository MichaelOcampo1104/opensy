# =========================================================================
# This script defines the gravity load pattern for the building model. The
# gravity loads consist of point loads applied to column nodes at floor
# levels (out-of-plane framing loads) and distributed loads applied to the
# beam elements (tributary floor, roof, and facade loads).
...
eleLoad -ele  527 530 532 534 535 -type -beamUniform -6.916667e-02 ;# B19
eleLoad -ele  537 539 542         -type -beamUniform -6.916667e-02 ;# B19
eleLoad -ele  543 546 548 550 551 -type -beamUniform -6.916667e-02 ;# B20
eleLoad -ele  553 555 558         -type -beamUniform -6.916667e-02 ;# B20
eleLoad -ele  559 562 564 566 567 -type -beamUniform -3.000000e-02 ;# B21
eleLoad -ele  569 571 574         -type -beamUniform -3.000000e-02 ;# B21
