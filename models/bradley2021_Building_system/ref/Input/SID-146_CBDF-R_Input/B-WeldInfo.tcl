...
set WeldDCRs [list \
   [expr abs($BR1)/(5.011619e+02*1.80)] \
   [expr abs($BR2)/(1.930402e+02*1.80)] \
   [expr abs($BR3)/(1.187939e+02*1.80)] \
   [expr abs($BR4)/(5.011619e+02*1.80)] \
   [expr abs($BR5)/(1.930402e+02*1.80)] \
   [expr abs($BR6)/(1.187939e+02*1.80)] \
]
