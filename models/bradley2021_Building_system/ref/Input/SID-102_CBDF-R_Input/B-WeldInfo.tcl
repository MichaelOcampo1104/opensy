...
set WeldDCRs [list \
   [expr abs($BR1)/(7.573114e+02*0.80)] \
   [expr abs($BR2)/(2.969848e+02*0.80)] \
   [expr abs($BR3)/(1.484924e+02*0.80)] \
   [expr abs($BR4)/(7.573114e+02*0.80)] \
   [expr abs($BR5)/(2.969848e+02*0.80)] \
   [expr abs($BR6)/(1.484924e+02*0.80)] \
]
