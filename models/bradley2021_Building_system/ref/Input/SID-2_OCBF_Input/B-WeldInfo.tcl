...
set WeldDCRs [list \
   [expr abs($BR1)/(3.489572e+02*1.00)] \
   [expr abs($BR2)/(2.747110e+02*1.00)] \
   [expr abs($BR3)/(2.375879e+02*1.00)] \
   [expr abs($BR4)/(3.489572e+02*1.00)] \
   [expr abs($BR5)/(2.747110e+02*1.00)] \
   [expr abs($BR6)/(2.375879e+02*1.00)] \
]
