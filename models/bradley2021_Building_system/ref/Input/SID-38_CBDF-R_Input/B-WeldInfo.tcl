...
set WeldDCRs [list \
   [expr abs($BR1)/(2.375879e+02*1.40)] \
   [expr abs($BR2)/(1.930402e+02*1.40)] \
   [expr abs($BR3)/(1.187939e+02*1.40)] \
   [expr abs($BR4)/(2.375879e+02*1.40)] \
   [expr abs($BR5)/(1.930402e+02*1.40)] \
   [expr abs($BR6)/(1.187939e+02*1.40)] \
]
