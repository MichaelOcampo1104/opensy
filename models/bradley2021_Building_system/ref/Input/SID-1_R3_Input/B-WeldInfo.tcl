...
set WeldDCRs [list \
   [expr abs($BR1)/(2.672864e+02*1.00)] \
   [expr abs($BR2)/(2.375879e+02*1.00)] \
   [expr abs($BR3)/(2.078894e+02*1.00)] \
   [expr abs($BR4)/(2.672864e+02*1.00)] \
   [expr abs($BR5)/(2.375879e+02*1.00)] \
   [expr abs($BR6)/(2.078894e+02*1.00)] \
]
