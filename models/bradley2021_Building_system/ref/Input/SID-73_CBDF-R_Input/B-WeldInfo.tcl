...
set WeldDCRs [list \
   [expr abs($BR1)/(2.895602e+02*1.80)] \
   [expr abs($BR2)/(2.301633e+02*1.80)] \
   [expr abs($BR3)/(1.336432e+02*1.80)] \
   [expr abs($BR4)/(2.895602e+02*1.80)] \
   [expr abs($BR5)/(2.301633e+02*1.80)] \
   [expr abs($BR6)/(1.336432e+02*1.80)] \
]
