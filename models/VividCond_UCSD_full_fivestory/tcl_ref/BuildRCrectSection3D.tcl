proc BuildRCrectSection {id HSec BSec coverH coverB coreID coverID steelID numBarsTop barAreaTop numBarsBot barAreaBot numBarsIntTot barAreaInt GJ GA nfCoreY nfCoreZ nfCoverY nfCoverZ} {
	################################################
	...
	uniaxialMaterial Elastic $id_temp $GA;
